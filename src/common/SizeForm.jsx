...
class SizeForm extends React.Component {
    ...
    render () {
        ...
        const { t, onOverlapBoxHover, unit, chooseUnit, inchFractionsPrecision, unitChoiceDisallowed } = this.props;
            ...
            <div className="measurement-input-table" ref={el => { this.elem = el; }}>
                ...
                {this.fields.map(({ field, humanProperty }) => (
                    <div className="measurement-cell" key={field} style={{ width: measurementCellWidth }}>
                        ...
                        <MeasurementInput onChange={this.valueChanged(humanProperty)} value={this.state.measurements[humanProperty]} unit={unit} 
                        chooseUnit={chooseUnit} inchFractionsPrecision={inchFractionsPrecision} unitChoiceDisallowed={unitChoiceDisallowed}
                        ...
                        {getFit(field).map(f =>
                            <OverlapBox fit={f} humanProperty={humanProperty} hover={() => onOverlapBoxHover(field)}
                                key={humanProperty} model={this.props.product.model} unit={unit} inchFractionsPrecision={inchFractionsPrecision}/>
                        ).orElse(null)}
                    </div>
                ))}
