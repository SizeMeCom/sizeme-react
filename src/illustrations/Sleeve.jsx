...
const Sleeve = (props) => {
	...
	c-5,0.333-134.166,7-134.166,7l-1.167-75.834L336.456,301.489z`}/>
            <path fill={props.colorScheme.baseFill.color} d="M455.956,313.823c0,0,44.333,1.836,57.833,1.418"/>
            <path fill="none"
			    stroke={props.colorScheme.mainLine.color}
			    strokeWidth={props.colorScheme.mainLine.width}
			    strokeLinecap="round"
            ...
            <path fill={props.colorScheme.baseFill.color} d="M453.956,333.823c0,0,49.699,0.836,64.833,0.418"/>
            <path fill="none"
			    stroke={props.colorScheme.mainLine.color}
			    strokeWidth={props.colorScheme.mainLine.width}
			    strokeLinecap="round"
            ...
            <rect x="0" y="277.819" fill={props.colorScheme.overlayFill.color}
			    stroke={props.colorScheme.mainLine.color}
			    strokeWidth={props.colorScheme.mainLine.width}
			    strokeLinecap="round"
			    strokeLinejoin="round"
			    strokeMiterlimit="10" width={sleeveWidth} height="97.245"/>
            <line fill="none"
