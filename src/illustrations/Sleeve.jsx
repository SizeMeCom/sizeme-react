...
const Sleeve = (props) => {
  ...
  return (
	...
	c-5,0.333-134.166,7-134.166,7l-1.167-75.834L336.456,301.489z`}
      />
      <path className="baseFill" d="M455.956,313.823c0,0,44.333,1.836,57.833,1.418" />
      <path className="mainLine noFill" d="M455.956,313.823c0,0,44.333,1.836,57.833,1.418" />
      <path className="baseFill" d="M453.956,333.823c0,0,49.699,0.836,64.833,0.418" />
      <path className="mainLine noFill" d="M453.956,333.823c0,0,49.699,0.836,64.833,0.418" />
      <path className="overlayFill" d="M446.628,354.124c0,0,32.815-0.629,42.735-1.797" />
      <path className="mainLine noFill" d="M446.628,354.124c0,0,32.815-0.629,42.735-1.797" />
      <rect className="mainLine overlayFill" x="0" y="274" width={sleeveWidth} height="103" />
      <line
