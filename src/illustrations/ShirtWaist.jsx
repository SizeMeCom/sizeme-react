...
const ShirtWaist = (props) => {
    ...
    return (
        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" className="shirtWaist"
             viewBox="108 90 337.5 270" preserveAspectRatio="xMidYMin meet">

            <defs>
                <marker id="triangleInsideShirtWaist"
                ...
                <marker id="triangleOutsideShirtWaist"
...
ShirtWaist.propTypes = {
    overlap: PropTypes.number
};

ShirtWaist.defaultProps = {
    overlap: 0
};

export default ShirtWaist;