  ...
  return (
    ...
    >
      <g>
        ...
        />
        <path className="mainLine noFill" d="M455,355,440,370,460,404,480,390" />
        ...
        {scale > 0 && (
          <path className="mainLine noFill" d="M476.423,344.657c0,0,12.57,0.209,13.093,12.81" />
        )}
        {scale > 0 && (
          <line
