...
export const { selectProfile, selectProfileDone, setMeasurements, savedMeasurements } = createActions(
    SELECT_PROFILE, SELECT_PROFILE_DONE, SET_MEASUREMENTS, SAVED_MEASUREMENTS
);
